...
/////
    ...
    gulp.task('content', function() {
        ...
        return gulp.src('src/content/**/*') // Read from this directory

            .pipe(gulp.dest('dist/content')) // Spit out in 'dist/favicons'
...
/////
    ...
    // Remove all Dist Directories
        gulp.task('clean-all', function() {
            return gulp.src(['dist/css', 'dist/js', 'dist/images', 'dist/fonts', 'dist/favicons', 'dist/content'], {read: false}) // Find these folders
                .pipe(clean()); // Delete them
        });
